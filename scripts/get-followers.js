var f_page = "pencilsketching"; // the page name for your fan page, e.g. the 'pencilsketching' part of http://facebook.com/pencilsketching
var t_page = "prabhugsp"; // the account name for your main twitter account
